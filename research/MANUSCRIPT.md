...
The support-first solver and all benchmark and reproduction scripts are available at https://github.com/Adelagric/ocs-rs (MIT licence) and archived at Zenodo (https://doi.org/10.5281/zenodo.20746987). Every table and figure is regenerated by `research/repro/repro.sh`. The marker panels are public: the wheat and mouse panels ship with the BGLR R package (Pérez & de los Campos 2014); the PIC pig panel is the Cleveland, Hickey & Forni (2012) common dataset (DOI 10.1534/g3.111.001453).
