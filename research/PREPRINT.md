...
| vs optiSel: shipped 12×–180×, algorithm ~90×–2500× | **Measured** | M4 Max, idle, medians (matrix-free/algorithm 5×, optiSel 3×), all six panels; pig shipped 0.622 s (80×) / algorithm 0.020 s (~2500×) vs optiSel 49.9 s; two-column Table 2, `research/repro/table2_numbers.md` |
