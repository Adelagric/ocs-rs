...
Table 1 was measured with) at n=500 and n=1000, provided Clarabel drops the n(n−1)/2
explicit zeros the generator carries for the triangular factor (left in: 3–5× slower).
