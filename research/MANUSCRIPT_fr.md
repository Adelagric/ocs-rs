...
Un solveur générique est une cible facile ; la comparaison informative se fait contre optiSel, l'outil OCS exact de référence, sur sa propre formulation. Après extension de support-first aux deux contraintes d'égalité de sexe, il renvoie le même optimum qu'optiSel tout en s'exécutant 90× à 2280× plus vite sur trois panels de marqueurs réels (Tableau 2), et 22× à 97× plus vite sur des populations synthétiques structurées. La plus grande marge est sur le panel de porc PIC (n = 3534), où optiSel prend 55 s et support-first 24 ms.

**Tableau 2.** support-first contre optiSel (R/`cccp`), même optimum partout.

| jeu de données | n | support-first | optiSel | accélération |
|---|---|---|---|---|
| synthétique (structuré) | 1000 | 0,09 s | 2,0 s | 22× |
| synthétique (structuré) | 2000 | 0,29 s | 11,9 s | 41× |
| synthétique (structuré) | 5000 | 1,47 s | 143 s | 97× |
| blé CIMMYT (GRM réelle) | 599 | 0,007 s | 0,63 s | 90× |
| porc PIC (GRM réelle, 52k SNP) | 3534 | 0,024 s | 54,8 s | **2280×** |
| souris HS (GRM réelle, sexe réel) | 1814 | 0,008 s | 6,96 s | 870× |
