...
AVAILABILITY = (
    ...
    "regenerated by `research/repro/repro.sh`, whose steps are labelled with the "
    "table or figure they produce; a step whose toolchain or dataset is absent is "
    "skipped with a message. Two exceptions are deliberate: the n = 10000 Clarabel "
    "point of Table 1 runs only under `REPRO_FULL=1` (Clarabel needs ~26 minutes "
    "there), and the AlphaMate comparison is run manually from an emulated binary. "
    "The marker panels are public: the "
